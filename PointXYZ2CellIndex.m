% Find the global index of a cell that encloses a given point 
...
% OUTPUT
%     cellInd: global cell index in the model vector
% NOTE
%     Return 0 if a point is outside the mesh.
%     If a point exactly at boundary, consider it for the next possible
...
%     interval.
% LAST MODIFIED 20200217 yangdikun@gmail.com
function cellInd = PointXYZ2CellIndex(points,nodeX,nodeY,nodeZ)
